...
describe('Building a custom hook', () => {
  ...
  it('registers a mouseenter event listener @on-mouse-enter', () => {
    expect(mockRef.current.addEventListener, 'Did you add the right event listener?').toHaveBeenCalledWith(
      'mouseenter',
      expect.any(Function)
    );
  });
  ...
  it('creates a callback for mouseenter @enter-callback', () => {
    ...
    expect(mockRef.current.addEventListener, 'Did you pass the right event?').toHaveBeenCalledWith(
      'mouseenter',
      expect.any(Function)
    );
  ...
  it('removes the mouseenter event listener @remove-mouseenter', () => {
    ...
    expect(mockRef.current.removeEventListener, 'Did you remove the mouseenter event listener?').toHaveBeenCalledWith(
      'mouseenter',
      expect.any(Function)
    );
  ...
  it('removes the mouseleave event listener @remove-mouseleave', () => {
    ...
    expect(mockRef.current.removeEventListener, 'Did you remove the mouseleave event listener?').toHaveBeenCalledWith(
      'mouseleave',
      expect.any(Function)
    );
